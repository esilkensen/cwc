...
covered by the evaluation contexts defined in the paper. Alternatively, we
could have defined a metafunction according to the code in the paper's
appendix.
...
% As a side effect, we also think this project will help us discover how a
